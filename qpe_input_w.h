...
//{
 ...
 //class QPEInputMethod : public QWidget
 {
  ...
  public:
   static QString string2qstring(std::string str,const char *codename="big5")
   {
	   /*
    QString qstr;
    if(codename==0) // ASCII
    ...
    */
   } // end static QString string2qstring(std::string str,const char *codename="big5")
   ...
   void draw_text(int x,int y,int w,int h,std::string str,const char *codename=0);
